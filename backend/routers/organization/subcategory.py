...
def create_subcategory(data: SubCategoryCreate, db: Session = Depends(get_tenant_db), current_user: dict = Depends(require_subcategory_create())):
...
def update_subcategory(sub_id: int, data: SubCategoryUpdate, db: Session = Depends(get_tenant_db), current_user: dict = Depends(require_subcategory_edit())):
...
def delete_subcategory(sub_id: int, db: Session = Depends(get_tenant_db), current_user: dict = Depends(require_subcategory_delete())):
