...
<body>
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 sm:p-6">
      ...
      {/* TABS */}
      <div className="mb-6">
        <div className="bg-white rounded-2xl p-3 sm:p-6 shadow-sm border">
          <div className="flex flex-col sm:flex-row space-y-1 sm:space-y-0 sm:space-x-1 bg-slate-100 p-1 rounded-lg">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                onClick={() => setActiveTab(tab.id)}
                className={`flex-1 flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-3 rounded-md text-xs sm:text-sm font-medium transition-colors ${
                  activeTab === tab.id
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border">
            {hasPermission("purchase_request.view") ? (
              <>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0 mb-4">
                  <h2 className="text-lg sm:text-xl font-semibold">Purchase Request List</h2>
                  <div className="flex flex-col sm:flex-row gap-2">
                    <button 
                      onClick={fetchPRList}
                      className="px-3 sm:px-4 py-2 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 transition-colors text-sm sm:text-base"
                    >
                      Refresh
                      </button>
              ...
              <>
                ...
                <div className="block sm:hidden">
                  <div className="space-y-4">
                    {prList.map((pr, index) => (
                      <div key={pr.id} className="bg-white border rounded-lg p-4 shadow-sm">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center space-x-3">
                            ...
                            <div className="min-w-0">
                              <div className="text-sm font-medium text-slate-900">{pr.pr_number}</div>
                              <div className="text-xs text-slate-500">By: {pr.requested_by}</div>
                            </div>
                          </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm mb-3">
                          <div>
                            ...
                            <div className="font-medium">{new Date(pr.request_date).toLocaleDateString()}</div>
                          </div>
                          <div>
                            ...
                            <select 
                              ...
                              className="text-xs px-2 py-1 rounded border focus:ring-1 focus:ring-blue-500 w-full"
                            >
                        ...
                        <div className="flex justify-end space-x-2 pt-2 border-t border-gray-100">
                          {hasPermission("purchase_request.edit") && (
                            <button 
                              ...
                              className="text-orange-600 hover:bg-orange-50 px-2 py-1 rounded transition-colors"
                              title="Edit PR"
                            >
            ...
            <div className="mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="text-xs sm:text-sm text-slate-500 text-center sm:text-left">Showing {prList.length} of {totalPRs} purchase requests (Page {currentPage} of {totalPages})</div>
              <div className="flex justify-center sm:justify-end gap-2">
                ...
                <span className="px-2 sm:px-3 py-1 text-xs sm:text-sm text-slate-600">Page {currentPage} of {totalPages}</span>
                <button
                  onClick={() => fetchPRList(currentPage + 1)}
      ...
      {activeTab === "PO" && (
        <div className="bg-white rounded-2xl p-6 shadow-sm border">
          {hasPermission("purchase_order.view") ? (
            <>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0 mb-4">
                <h2 className="text-lg sm:text-xl font-semibold">Purchase Order List</h2>
              ...
              {poList.length === 0 ? (
                ...
                <>
                  ...
                  <div className="block sm:hidden">
                    <div className="space-y-4">
                      {poList.map((po, index) => (
                        <div key={po.id} className="bg-white border rounded-lg p-4 shadow-sm">
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="min-w-0">
                                ...
                                <div className="text-xs text-slate-500">{po.vendor_name || 'Unknown Vendor'}</div>
                              </div>
                            </div>
                          ...
                          <div className="grid grid-cols-2 gap-3 text-sm mb-3">
                            <div>
                              ...
                              <div className="font-medium">{po.pr_number}</div>
                            </div>
                            <div>
                              <span className="text-slate-500">Date:</span>
                              <div className="font-medium">{new Date(po.po_date).toLocaleDateString()}</div>
                            </div>
                          </div>
              ...
              <div className="mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div className="text-xs sm:text-sm text-slate-500 text-center sm:text-left">Showing {poList.length} of {totalPOs} purchase orders (Page {currentPOPage} of {totalPOPages})</div>
                <div className="flex justify-center sm:justify-end gap-2">
                  <button
                  ...
                  <span className="px-2 sm:px-3 py-1 text-xs sm:text-sm text-slate-600">Page {currentPOPage} of {totalPOPages}</span>
                  <button
                    onClick={() => fetchPOList(currentPOPage + 1)}
      ...
      {activeTab === "Tracking" && (
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl p-4 sm:p-6 shadow-sm border">
            <h2 className="text-lg sm:text-xl font-semibold mb-4">Create PO Tracking</h2>
            <div className="space-y-4">
              <div>
          ...
          <div className="lg:col-span-3 bg-white rounded-2xl p-4 sm:p-6 shadow-sm border">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0 mb-4">
              <h2 className="text-lg sm:text-xl font-semibold">POs with Tracking - Status Management</h2>
              <button 
                ...
                <div className="block lg:hidden">
                  <div className="space-y-4">
                    {trackingList.map((trackingInfo, index) => {
                      ...
                      return (
                        <div key={trackingInfo.id} className="bg-white border rounded-lg p-4 shadow-sm">
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="min-w-0">
                                <div className="text-sm font-medium text-slate-900">{trackingInfo.po_number}</div>
                                <div className="text-xs text-slate-500">{po?.vendor || 'N/A'}</div>
                              </div>
                            </div>
                            <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                          ...
                          <div className="pt-2 border-t border-gray-100">
                            <select 
                              ...
                              className="w-full text-sm px-2 py-1 rounded border focus:ring-1 focus:ring-blue-500"
                            >
          ...
          <div className="bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold">{editingPR ? 'Edit Purchase Request' : 'Create Purchase Request'}</h3>
